...
function LoginFormContentInner({ variant = 'page', callbackUrl: callbackUrlProp }: LoginFormContentProps) {
  ...
  const wrapperClass = variant === 'modal' ? 'space-y-6' : 'min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8'
  const innerClass = variant === 'modal' ? 'w-full' : 'max-w-md w-full space-y-8'
    ...
    return (
      <div className={wrapperClass}>
        <div className={innerClass}>
          <div>
            <h2 className={variant === 'modal' ? 'text-xl font-extrabold text-gray-900 dark:text-white' : 'mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-white'}>
              Enter MFA Code
            </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-2 text-gray-500 dark:text-gray-400 ${variant === 'modal' ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-900'}`}>
                Or
              </span>
            </div>
          </div>
