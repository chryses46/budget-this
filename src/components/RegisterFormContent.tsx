...
export function RegisterFormContent({ variant = 'page', onSuccess }: RegisterFormContentProps) {
  ...
  const wrapperClass = variant === 'modal' ? 'space-y-6' : 'min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8'
  const cardBg = variant === 'modal' ? '' : 'bg-white dark:bg-gray-800'

  if (verificationSuccess) {
    return (
      <div className={variant === 'modal' ? 'py-4 text-center' : 'min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8'}>
        <div className={variant === 'modal' ? 'space-y-4' : 'sm:mx-auto sm:w-full sm:max-w-md'}>
          <div className={`${cardBg} ${variant === 'modal' ? '' : 'py-8 px-4 shadow sm:rounded-lg sm:px-10'} text-center`}>
            <div className="mb-4">
  ...
  if (success) {
    return (
      <div className={wrapperClass}>
        <div className={variant === 'modal' ? 'space-y-6' : 'sm:mx-auto sm:w-full sm:max-w-md'}>
          <h2 className={variant === 'modal' ? 'text-xl font-bold text-gray-900 dark:text-white' : 'mt-6 text-center text-3xl font-bold text-gray-900 dark:text-white'}>
            Verify your email
          </h2>
        ...
        <div className={variant === 'modal' ? 'mt-4' : 'mt-8 sm:mx-auto sm:w-full sm:max-w-md'}>
          <div className={`${cardBg} py-8 px-4 shadow sm:rounded-lg sm:px-10`}>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className={`px-2 ${variant === 'modal' ? 'bg-white dark:bg-gray-800' : 'bg-white dark:bg-gray-800'} text-gray-500 dark:text-gray-400`}>Or</span>
                </div>
              </div>
